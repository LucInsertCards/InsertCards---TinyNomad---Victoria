...
const InfoStep = ({ onContinue, onBack, onSkipToGifts, initialData = {}, theme }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      <div className="max-w-md w-full">
        <h2 className="text-3xl md:text-4xl font-bold tracking-wide text-center mb-3 text-gray-900">
          Let's get started
        </h2>
        <p className="text-center text-gray-500 mb-10">
          Tell us a bit about yourself to claim your gifts
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              } focus:outline-none focus:border-current transition-colors`}
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500">
              Your free gifts will be sent to this email address
            </p>
          </div>
          ...
          <div className="flex items-start space-x-3 pt-2">
            ...
            <label htmlFor="optInSurveys" className="text-sm text-gray-600 leading-relaxed cursor-pointer">
              I'd like to participate in product surveys and get a chance to win free test versions of our upcoming products!
            </label>
          </div>
          ...
          <div className="pt-4 flex gap-3">
            ...
            <button
              ...
              className={`flex-1 px-8 py-4 text-lg font-semibold tracking-wide rounded-xl transition-all duration-300 shadow-lg
                ${isFormValid
                  ? `${theme.btnClass} hover:shadow-xl cursor-pointer`
